// V141 - EXACT V108 LOGIC RESTORE
// Range: 14 Days
// Pages: 2
// Sort: Default (Chronological) - This is what worked before!
...
exports.handler = async function(event, context) {
    ...
    try {
        ...
        // 2. FETCH 2 PAGES (Parallel) - NO SORT PARAMETER
        // Removing &sortorder=desc because V108 worked without it.
        ...
        // 3. CLEAN & FLAG (V122 Frontend Logic needs these flags)
        ...
        return { 
            ...
            body: JSON.stringify({ 
                ...
                meta: { count: cleanEntries.length, v: "141" }
            }) 
        };
